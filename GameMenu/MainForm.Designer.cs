...
namespace GameMenu
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.listView1.LargeImageList.ImageSize = new System.Drawing.Size(64, 64);
            this.listView1.Size = new System.Drawing.Size(800, 372);
            ...
            this.contextMenuStrip.Items.Add("启动").Click += this.startApplication;
            this.contextMenuStrip.Items.Add("重命名").Click += this.renameItem;
            this.contextMenuStrip.Items.Add("删除").Click += this.removeItem;
            // 
            // MainForm
            // 
        ...
        private void listviewEventHandler(object sender, MouseEventArgs args)
        {
            if(args.Button == MouseButtons.Right)
            {
                Console.WriteLine(sender.ToString());
                selectedListItems = ((ListView)sender).SelectedItems;
                this.contextMenuStrip.Show(this.listView1, args.Location);
            }
        }
        ...
        private void startApplication(object sender, EventArgs args)
        {
            foreach (ListViewItem listViewItem in selectedListItems)
            {
                Process.Start((string)listViewItem.Tag);
            }
        }
        ...
        private SelectedListViewItemCollection selectedListItems;
    }
}